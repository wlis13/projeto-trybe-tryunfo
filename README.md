...
<details>
  ...
  * Data para entrega final do projeto: `01/09/2022 14:00`.
...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-024-b-project-tryunfo.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-024-b-project-tryunfo`
  ...
  - Agora crie uma branch à qual você vai submeter os `commits` do seu projeto
    ...
    - Exemplo: `git checkout -b joaozinho-sd-024-b-project-tryunfo`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-sd-024-b-project-tryunfo`

  6. Crie um novo `Pull Request` _(PR)_

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-024-b-project-tryunfo/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-024-b-project-tryunfo/pulls) e confira que o seu _Pull Request_ está criado
